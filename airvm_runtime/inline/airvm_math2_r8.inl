// 数学二地址码：op subop,des,src  : src => des :8-8-8-8
case op_math2_r8_subop:
{
    ...
    {
        reg[des] = ~reg[src];
        insresult("%4X: not_r8_w32  \tr%d, \tr%d \tresult: 0x%X\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_not_w64:
    {
        *(uint64_t *)&reg[des] = ~(*(uint64_t *)&reg[src]);
        insresult("%4X: not_r8_w64 \tr%d, \tr%d \tresult: 0x%llX\n",
    ...
    {
        reg[des] = !reg[src];
        insresult("%4X: inv_r8_w32  \tr%d, \tr%d \tresult: 0x%X\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        *(uint64_t *)&reg[des] = !(*(uint64_t *)&reg[src]);
        insresult("%4X: inv_r8_w64 \tr%d, \tr%d \tresult: 0x%llX\n",
                  *pc, des, src, *(uint64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_neg_i32:
    {
        *(int32_t *)&reg[des] = -(*(int32_t *)&reg[src]);
        insresult("%4X: neg_r8_i32 \tr%d, \tr%d \tresult: %d\n",
    ...
    case subop_math2_neg_i64:
    {
        *(int64_t *)&reg[des] = -(*(int64_t *)&reg[src]);
        insresult("%4X: neg_r8_i64 \tr%d, \tr%d \tresult: %lld\n",
    ...
    case subop_math2_neg_f32:
    {
        *(flt32_t *)&reg[des] = -(*(flt32_t *)&reg[src]);
        insresult("%4X: neg_r8_f32 \tr%d, \tr%d \tresult: %f\n",
    ...
    case subop_math2_neg_f64:
    {
        *(flt64_t *)&reg[des] = -(*(flt64_t *)&reg[src]);
        insresult("%4X: neg_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
    ...
    case subop_math2_abs_i32:
    {
        *(int32_t *)&reg[des] = abs(*(int32_t *)&reg[src]);
        insresult("%4X: abs_r8_i32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, *(int32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_abs_i64:
    {
        *(int64_t *)&reg[des] = _abs64(*(int64_t *)&reg[src]);
        insresult("%4X: abs_r8_i64 \tr%d, \tr%d \tresult: %lld\n",
                  *pc, des, src, *(int64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_abs_f32:
    {
        ...
        insresult("%4X: abs_r8_f32 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_abs_f64:
    {
        *(uint64_t *)&reg[des] = (*(uint64_t *)&reg[src]) & (~(1ull << 63));
        insresult("%4X: abs_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_cmpltz_i32:
    {
        ...
        insresult("%4X: cmpltz_r8_i32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(int32_t *)&reg[src]) == 0;
        insresult("%4X: cmpeqz_r8_i32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(int32_t *)&reg[src]) != 0;
        insresult("%4X: cmpnez_r8_i32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(int32_t *)&reg[src]) > 0;
        insresult("%4X: cmpgtz_r8_i32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(int32_t *)&reg[src]) >= 0;
        insresult("%4X: cmpgez_r8_i32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_cmpltz_i64:
    {
        ...
        insresult("%4X: cmpltz_r8_i64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(int64_t *)&reg[src]) == 0;
        insresult("%4X: cmpeqz_r8_i64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(int64_t *)&reg[src]) != 0;
        insresult("%4X: cmpnez_r8_i64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(int64_t *)&reg[src]) > 0;
        insresult("%4X: cmpgtz_r8_i64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(int64_t *)&reg[src]) >= 0;
        insresult("%4X: cmpgez_r8_i64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_cmpltz_f32:
    {
        ...
        insresult("%4X: cmpltz_r8_f32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(flt32_t *)&reg[src]) == 0;
        insresult("%4X: cmpeqz_r8_f32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(flt32_t *)&reg[src]) != 0;
        insresult("%4X: cmpnez_r8_f32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(flt32_t *)&reg[src]) > 0;
        insresult("%4X: cmpgtz_r8_f32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(flt32_t *)&reg[src]) >= 0;
        insresult("%4X: cmpgez_r8_f32 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_cmpltz_f64:
    {
        ...
        insresult("%4X: cmpltz_r8_f64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(flt64_t *)&reg[src]) == 0;
        insresult("%4X: cmpeqz_r8_f64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(flt64_t *)&reg[src]) != 0;
        insresult("%4X: cmpnez_r8_f64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(flt64_t *)&reg[src]) > 0;
        insresult("%4X: cmpgtz_r8_f64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        reg[des] = (*(flt64_t *)&reg[src]) >= 0;
        insresult("%4X: cmpgez_r8_f64 \tr%d, \tr%d \tresult: %d\n",
                  *pc, des, src, reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_sin_f32:
    {
        *(flt32_t *)&reg[des] = sinf(*(flt32_t *)&reg[src]);
        insresult("%4X: sin_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_sin_f64:
    {
        *(flt64_t *)&reg[des] = sin(*(flt64_t *)&reg[src]);
        insresult("%4X: sin_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_cos_f32:
    {
        *(flt32_t *)&reg[des] = cosf(*(flt32_t *)&reg[src]);
        insresult("%4X: cos_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_cos_f64:
    {
        *(flt64_t *)&reg[des] = cos(*(flt64_t *)&reg[src]);
        insresult("%4X: cos_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_tan_f32:
    {
        *(flt32_t *)&reg[des] = tanf(*(flt32_t *)&reg[src]);
        insresult("%4X: tan_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_tan_f64:
    {
        *(flt64_t *)&reg[des] = tan(*(flt64_t *)&reg[src]);
        insresult("%4X: tan_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_cot_f32:
    {
        *(flt32_t *)&reg[des] = 1.0f / tanf(*(flt32_t *)&reg[src]);
        insresult("%4X: cot_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_cot_f64:
    {
        *(flt64_t *)&reg[des] = 1.0 / tan(*(flt64_t *)&reg[src]);
        insresult("%4X: cot_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_sec_f32:
    {
        *(flt32_t *)&reg[des] = 1.0f / cosf(*(flt32_t *)&reg[src]);
        insresult("%4X: sec_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_sec_f64:
    {
        *(flt64_t *)&reg[des] = 1.0 / cos(*(flt64_t *)&reg[src]);
        insresult("%4X: sec_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_csc_f32:
    {
        *(flt32_t *)&reg[des] = 1.0f / sinf(*(flt32_t *)&reg[src]);
        insresult("%4X: csc_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_csc_f64:
    {
        *(flt64_t *)&reg[des] = 1.0 / sin(*(flt64_t *)&reg[src]);
        insresult("%4X: csc_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_asin_f32:
    {
        *(flt32_t *)&reg[des] = asinf(*(flt32_t *)&reg[src]);
        insresult("%4X: asin_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_asin_f64:
    {
        *(flt64_t *)&reg[des] = asin(*(flt64_t *)&reg[src]);
        insresult("%4X: asin_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_acos_f32:
    {
        *(flt32_t *)&reg[des] = acosf(*(flt32_t *)&reg[src]);
        insresult("%4X: acos_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    {
        *(flt64_t *)&reg[des] = cos(*(flt64_t *)&reg[src]);
        insresult("%4X: acos_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_atan_f32:
    {
        *(flt32_t *)&reg[des] = atanf(*(flt32_t *)&reg[src]);
        insresult("%4X: atan_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_atan_f64:
    {
        *(flt64_t *)&reg[des] = atan(*(flt64_t *)&reg[src]);
        insresult("%4X: atan_r8_f64 \tr%d, \tr%d \tresult: %lf\n",
                  *pc, des, src, *(flt64_t *)&reg[des]);
        *pc += 2;
        continue;
    }
    ...
    case subop_math2_acot_f32:
    {
        *(flt32_t *)&reg[des] = atanf(1.0f / *(flt32_t *)&reg[src]);
        insresult("%4X: acot_r8_f64 \tr%d, \tr%d \tresult: %f\n",
                  *pc, des, src, *(flt32_t *)&reg[des]);
        *pc += 2;
        continue;
    }
